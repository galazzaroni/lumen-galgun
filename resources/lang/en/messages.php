...
return [
    ...
    'password_reset_text' => 'You have requested to reset your password on :Website. Use the link below to set a new password.',
    'password_reset_link' => 'Please click here in order to reset your password.',
];
